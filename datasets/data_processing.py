...
def visualize_patched_image(image_array):
    ...
    for x in range(0, image_array.shape[-1], 128):
        cv.line(grid_iamge, (x, 0), (x, image_array.shape[0]), (255, 255, 255), 1)
    return  grid_iamge
...
def image_array_processing(image_array, image_fixed_size):
    ...
    return einops.rearrange(normalized_image_array, 'height (width patch_width) -> (width) (height patch_width)', patch_width=128)
